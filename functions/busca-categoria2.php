<?php 
    ...
    if ($categoria == '4') {
    	$resultados = $c->getResults("i9_veiculos","WHERE (nome LIKE '%".$busca."%') AND (id_categoria = ".$categoria.") AND (id_subcategoria = ".$subcategoria.") AND (ativo = '1') OR (descricao LIKE '%".$busca."%') AND (id_categoria = ".$categoria.") AND (id_subcategoria = ".$subcategoria.") AND (ativo = '1')");
    } else {
    	$resultados = $c->getResults("i9_formulas","WHERE (nome LIKE '%".$busca."%') AND (id_categoria = ".$categoria.") AND (id_subcategoria = ".$subcategoria.") AND (ativo = '1') OR (descricao LIKE '%".$busca."%') AND (id_categoria = ".$categoria.") AND (id_subcategoria = ".$subcategoria.") AND (ativo = '1')");
    }
