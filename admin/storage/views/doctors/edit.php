...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-9">
                    <h1 class="m-0 text-dark" style="line-height: 70px;">EDITAR MÉDICO</h1>
                </div>
                <div class="col-sm-3">
    ...
    <div class="container-fluid" style="background: #fff; padding:20px; border-radius: 10px; width: 98%; border:1px solid #b3aaaa">
        <form method="post" id="create" action="<?= url('doctors/update/'.$doctor->id) ?>" enctype="multipart/form-data" data-title="MÉDICO">
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        <input type="text" name="nome" class="form-control" placeholder="Digite o nome do médico" required value="<?=$doctor->nome?>"/>
                    </div>
                </div>
            </div>
            <hr/>
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        <input type="text" name="empresa" class="form-control" placeholder="Digite o nome da empresa" required value="<?=$doctor->empresa?>"/>
                    </div>
                </div>
            </div>
            <hr/>
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        <input type="text" name="telefone" class="form-control" placeholder="Digite o número de telefone" required value="<?=$doctor->telefone?>"/>
                    </div>
                </div>
            </div>
            <hr/>
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        <input type="text" name="endereco" class="form-control" placeholder="Digite o Endereço" required value="<?=$doctor->endereco?>"/>
                    </div>
                </div>
            </div>
            <hr/>
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        <input type="email" name="email" class="form-control" placeholder="Digite o e-email" required value="<?=$doctor->email?>"/>
                    </div>
                </div>
            </div>
            <hr/>
            ...
            <div class="form-group">
                ...
                <select class="custom-select rounded-0 tipo" name="tipo" required>
                    ...
                    <option value="1" <?= $doctor->tipo == 1 ? 'selected' : '' ?>>Médico</option>
                    <option value="3" <?= $doctor->tipo == 3 ? 'selected' : '' ?>>Outros</option>
                    <option value="4" <?= $doctor->tipo == 4 ? 'selected' : '' ?>>Funcionário</option>
                </select>
            </div>
            <hr/>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        <?php if(!empty($doctor->tipo_identificacao)): ?>
                            <label><?=$doctor->tipo_identificacao?></label>
                        <?php endif; ?>
                        <input type="text" name="identificacao" class="form-control identificacao" required placeholder="Digite o código, CRM, CRF, CRBM etc.." value="<?= $doctor->identificacao ?>" <?= $doctor->tipo == 4 ? 'disabled' : ''?>/>
                        <input type="hidden" name="tipo_identificacao" class="form-control tipo_identificacao" value="<?= $doctor->tipo_identificacao ?>" />
                        <input type="hidden" name="img_antiga" class="form-control img_antiga" value="<?= $doctor->logo ?>" />
                    </div>
                </div>
            </div>
            <hr/>
            <div class="form-group">
                ...
                <select class="custom-select rounded-0" name="status" required>
                    <option value="1" <?= $doctor->status == 1 ? 'selected' : ''?> >Habilitado</option>
                    <option value="2" <?= $doctor->status == 2 ? 'selected' : ''?> >Desabilitado</option>
                </select>
            </div>
            <hr/>
            <div class="row">
