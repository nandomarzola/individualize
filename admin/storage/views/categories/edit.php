...
<div class="content-wrapper">
    ...
    <div class="container-fluid" style="background: #fff; padding:20px; border-radius: 10px; width: 98%; border:1px solid #b3aaaa">
        <form method="post" id="create" action="<?= url('categories/update/'.$categorie->id) ?>" enctype="multipart/form-data" data-title="CATEGORIA">
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        <input type="text" name="name" class="form-control" placeholder="Nome da categoria" required value="<?= $categorie->nome?>">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="form-group">
                        <input type="text" name="cor" class="form-control" placeholder="Cor Ex:#FFFFFF" required value="<?= $categorie->cor?>" maxlength="7">
                    </div>
                </div>
            </div>
            <hr/>
